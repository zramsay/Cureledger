 ...
 */
const deployDsciToken: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  /*
...
export default deployDsciToken;

// Tags are useful if you have multiple deploy files and only want to run one of them.
// e.g. yarn deploy --tags YourToken
deployDsciToken.tags = ["DsciToken"];