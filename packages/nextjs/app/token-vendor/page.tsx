  ...
  return (
    <>
      <div className="flex items-center flex-col flex-grow pt-10">
        <div className="flex flex-col items-center bg-base-200 shadow-lg shadow-secondary-content border-8 border-secondary-content rounded-xl p-6 mt-24 w-full max-w-lg">
